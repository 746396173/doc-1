...
'/////////////////////请求参数/////////////////////
        ...
        '服务器异步通知页面路径
        notify_url = "http://www.xxx.com/alipay.trade.direct.forcard.pay-ASP-UTF-8/notify_url.asp"
        '需http://格式的完整路径，不允许加?id=123这类自定义参数
        '页面跳转同步通知页面路径
        return_url = "http://www.xxx.com/alipay.trade.direct.forcard.pay-ASP-UTF-8/return_url.asp"
        '需http://格式的完整路径，不允许加?id=123这类自定义参数
        '商户订单号
...
'构造请求参数数组
sParaTemp = Array("service=alipay.trade.direct.forcard.pay","partner="&partner,"_input_charset="&input_charset  ,"notify_url="&notify_url   ,"return_url="&return_url   ,"out_trade_no="&out_trade_no   ,"subject="&subject   ,"paymethod="&paymethod   ,"default_bank="&default_bank   ,"extend_param="&extend_param   ,"seller_logon_id="&seller_logon_id   ,"total_fee="&total_fee   ,"body="&body   ,"show_url="&show_url   ,"currency="&currency  )
