...
/**************************请求参数**************************/
        ...
        //服务器异步通知页面路径
        $notify_url = "http://www.xxx.com/alipay.trade.direct.forcard.pay-PHP-UTF-8/notify_url.php";
        //需http://格式的完整路径，不允许加?id=123这类自定义参数
        //页面跳转同步通知页面路径
        $return_url = "http://www.xxx.com/alipay.trade.direct.forcard.pay-PHP-UTF-8/return_url.php";
        //需http://格式的完整路径，不允许加?id=123这类自定义参数
        //错误信息返回的页面显示地址
        $error_return_url = $_POST['WIDerror_return_url'];
        //商户订单号
