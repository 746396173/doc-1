...
define('MODULE_PAYMENT_ALIPAYFOR_MARK_BUTTON_IMG', DIR_WS_CATALOG . 'includes/modules/payment/alipay/logo/alipay_en.gif');
...
if (IS_ADMIN_FLAG === true) {
    define('MODULE_PAYMENT_ALIPAYFOR_VERSION', 'ZC-FORCARD-5.2');
