...
define('MODULE_PAYMENT_ALIPAYFOR_NOTIFY_VERIFY_USE_HTTPS', true);//tokyo service, should use "false", add by vincent
...
class alipay_forcard
{
    ...
    function getCards()
    {
        ...
        if (MODULE_PAYMENT_ALIPAYFOR_PAYMETHOD == 'boc') {
            $cards['jcb'] = 'JCB Card';
        }
